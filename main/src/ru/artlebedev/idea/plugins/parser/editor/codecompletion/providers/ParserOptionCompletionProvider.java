...
import ru.artlebedev.idea.plugins.parser.editor.codecompletion.builders.ParserOptionLookupElementBuilder;
...
public class ParserOptionCompletionProvider
  ...
  protected void addCompletions(@NotNull CompletionParameters parameters,
    ...
    for (String optionLookupElement : optionLookupElements) {
      result.addElement(ParserOptionLookupElementBuilder.create(optionLookupElement));
    }
  }
}
