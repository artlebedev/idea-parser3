...
public class ParserDocDynamicInfoImpl extends ParserElementImpl implements ParserDocDynamicInfo, PsiReference {
  public ParserDocDynamicInfoImpl(ASTNode astNode) {
    super(astNode);
  }
