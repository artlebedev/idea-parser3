 ...
 * -- dwr
 */
public class ParserExpandLookupElement extends ParserLookupElement {
  public ParserExpandLookupElement(String keyword) {
    super(keyword);
  }

  @Override
  public void renderElement(LookupElementPresentation presentation) {
      presentation.setIcon(IconLoader.getIcon("/duplicates/sendToTheRight.png"));
